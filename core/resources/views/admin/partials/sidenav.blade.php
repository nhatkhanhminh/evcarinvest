        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.miner.*')}}">
                    <a href="{{route('admin.miner.index')}}" class="nav-link ">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive(['admin.plan*', 'admin.feature*'],3)}}">
                    ...
                    <div class="sidebar-submenu {{menuActive(['admin.plan*', 'admin.feature*'],2)}} ">
                        <ul>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.sale.*')}}">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.report*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive(['admin.report.referral.bonus.log'])}}">
                                <a href="{{route('admin.report.referral.bonus.log')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item mt-2">
                    <div class="nav-link d-flex justify-content-center">
                        <span>
                            <span class="text--success font-weight-bold">{{ systemDetails()['name'] }}</span>
                            <span class="text--amber">@lang('V'){{ systemDetails()['version'] }} </span>
                        </span>
                    </div>
                </li>
            </ul>
