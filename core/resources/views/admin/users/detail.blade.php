        ...
        <div class="col-xl-3 col-lg-5 col-md-5 mb-30">
            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Refered By')
                            <span class="font-weight-bold">{{$user->referrer->username}}</span>
                        </li>
                        @endif
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Balance')
                            <span class="font-weight-bold">{{getAmount($user->balance,8)}}  {{__($general->cur_text)}}</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.users.coinbalance', $user->id) }}"
                       class="btn btn--info btn--shadow btn-block btn-lg">
                        @lang('Coin Balance List')
                    </a>
            ...
            <div class="row mb-none-30">
                    ...
                    <div class="dashboard-w1 bg--deep-purple b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                ...
                                <span class="amount">{{getAmount($totalDeposit,8)}}</span>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--indigo b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="currency-sign">{{__($general->cur_sym)}}</span>
                                <span class="amount">{{getAmount($totalWithdraw,8)}}</span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$general->cur_sym}} {{getAmount($totalInvest, 8)}}</span>
                            </div>
                            <div class="desciption">
