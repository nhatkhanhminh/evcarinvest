                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold"> @lang('Preloader Title') </label>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group ">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control form-control-lg integer-validation" type="text" name="referral_bonus" value="{{$general->referral_bonus}}">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn--primary btn-block btn-lg mt-3">@lang('Update')</button>
                        </div>
                    </form>
                </div>
            </div>
