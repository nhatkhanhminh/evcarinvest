...
<div class="col-lg-6">
    <div class="register-form-area">
        ...
        <div class="account-header text-center">
            ...
            <p class="sub-title">@lang('Your Email'):  <strong>{{auth()->user()->email}}</strong></p>
        </div>

        <form action="{{route('user.verify_email')}}" method="POST" class="register-form">
            @csrf
            ...
            <div class="form-group">
                <p>@lang('Please check including your Junk/Spam Folder. if not found, you can') <a class="text-primary" href="{{route('user.send_verify_code')}}?type=email" class="forget-pass"> @lang('Resend code')</a></p>
