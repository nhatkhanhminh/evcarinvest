            ...
            <div class="card card-deposit rounded-0">
                ...
                <div class="card-footer">
                    <a href="javascript:void(0)" data-id="{{$data->id}}" data-resource="{{$data}}"
                        ...
                        data-percent_charge="{{getAmount($data->percent_charge)}}" class="cmn-btn btn-block deposit" data-toggle="modal" data-target="#paymentModal">
                        @lang('Deposit Now')</a>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        (function($){
            $('.deposit').on('click', function () {
                ...
                $('.method-name').text(`@lang('Deposit By ') ${result.name}`);
