...
class ReportController extends Controller
{
    ...
    public function referralBonusLog()
    {
        ...
        $logs       = ReferralLog::with('user')->orderBy('id','desc')->paginate(getPaginate());
        $empty_message = 'No referral bonus yet.';
        return view('admin.reports.referral_bonus_log', compact('page_title', 'logs', 'empty_message'));
    }
