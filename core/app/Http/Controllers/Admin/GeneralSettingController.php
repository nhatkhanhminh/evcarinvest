...
class GeneralSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $validation_rule = [
            ...
            'preloader_title' => ['nullable', 'string', 'max:12'],
            'referral_bonus'    => ['required','integer', 'gte:0'],
        ];
        ...
        $general_setting->update($request->only(['sitename', 'cur_text', 'cur_sym', 'ev', 'en', 'sv', 'sn', 'registration', 'base_color', 'preloader_title', 'referral_bonus', 'referral_system']));
