...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin','access'])->group(function () {
        ...
        // Miner
        Route::get('miners', 'MinerController@index')->name('miner.index');
        Route::get('miner/plans/{id}', 'MinerController@plans')->name('miner.plans');

        Route::post('miner/store', 'MinerController@store')->name('miner.store');
        Route::post('miner/update/{id}', 'MinerController@update')->name('miner.update');
        ...
        Route::post('feature/delete/{feature}', 'FeatureController@delete')->name('feature.remove');
        ...
        // Sales
        Route::get('sales', 'PlanController@sales')->name('sale.index');
        ...
        Route::get('user/coinbalance/{id}', 'ManageUsersController@coinBalance')->name('users.coinbalance');
        ...
        Route::get('report/referral/bonus/log/', 'ReportController@referralBonusLog')->name('report.referral.bonus.log');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
           ...
           // Plans
           Route::get('plans', 'OrderPlanController@plans')->name('plans');
           Route::get('plans/purchased', 'OrderPlanController@purchasedPlan')->name('plans.purchased');

           // Plans
           Route::get('referral/invite', 'UserController@referral')->name('referral');
           Route::get('referral/log', 'UserController@referralLog')->name('referral.log');


            // Buy Plans
            Route::post('plan/order', 'OrderPlanController@orderPlan')->name('plan.order');

            // Payment
            Route::get('/payment', 'OrderPlanController@payment')->name('payment');

            // Wallets
            Route::get('/wallets', 'UserController@wallets')->name('wallets');
            Route::post('/wallets', 'UserController@walletUpdate')->name('wallet.update');
...
Route::get('/plans', 'SiteController@plans')->name('plan');
