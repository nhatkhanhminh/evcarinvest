									...
									<div class="info-item">
										...
										<div class="row">
											<div class="information-form-group col-sm-6">
												<input type="text" name="user" placeholder="Username" value="NullJungle" required>
											</div>
											<div class="information-form-group col-sm-6">
												<input type="text" name="code" placeholder="Purchase Code" value="Nulled-By-NullJungle" required>
											</div>
										</div>
									</div>
									<div class="info-item">
